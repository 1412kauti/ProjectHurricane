...
# Form implementation generated from reading ui file 'change_Driver_Email.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.change_Driver_Email_Label = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.change_Driver_Email_Label.setObjectName("change_Driver_Email_Label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.change_Driver_Email_Label)
