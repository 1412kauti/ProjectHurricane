...
# Form implementation generated from reading ui file 'change_User_Password.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.change_User_Password_Label = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.change_User_Password_Label.setEchoMode(QtWidgets.QLineEdit.Password)
        self.change_User_Password_Label.setObjectName("change_User_Password_Label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.change_User_Password_Label)
        self.label_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_2)
        self.change_User_Confirm_Password_Label = QtWidgets.QLineEdit(self.formLayoutWidget)
