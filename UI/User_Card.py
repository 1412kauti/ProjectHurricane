...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.User_Card_Name = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.User_Card_Name.setObjectName("User_Card_Name")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.User_Card_Name)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(119, 19, 271, 141))
