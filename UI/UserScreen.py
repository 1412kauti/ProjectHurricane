...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 0, 471, 457))
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "journey_ID"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "start_location"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "driver_name"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Car Class"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "car_make"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "car_colour"))
